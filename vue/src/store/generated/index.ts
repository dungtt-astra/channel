...
import AstraProtocolChannelChannelChannel from './AstraProtocol/channel/channel.channel'
import ChannelChannelChannel from './channel/channel.channel'
...
export default { 
  AstraProtocolChannelChannelChannel: load(AstraProtocolChannelChannelChannel, 'channel.channel'),
  ChannelChannelChannel: load(ChannelChannelChannel, 'channel.channel'),
