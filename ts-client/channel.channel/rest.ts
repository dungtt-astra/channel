...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/channel/channel/commitment
   */
  queryCommitmentAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<ChannelQueryAllCommitmentResponse, RpcStatus>({
      path: `/channel/channel/commitment`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/channel/channel/commitment/{index}
   */
   ...
   * @request GET:/channel/channel/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ChannelQueryParamsResponse, RpcStatus>({
      path: `/channel/channel/params`,
      method: "GET",
      format: "json",
      ...params,
    });
