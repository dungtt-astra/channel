...
func (k Keeper) ChannelAll(c context.Context, req *types.QueryAllChannelRequest) (*types.QueryAllChannelResponse, error) {
	if req == nil {
...
func (k Keeper) Channel(c context.Context, req *types.QueryGetChannelRequest) (*types.QueryGetChannelResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
	ctx := sdk.UnwrapSDKContext(c)
